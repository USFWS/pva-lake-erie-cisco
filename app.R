            ...
            tabItem(tabName = "menuAdvanced",
                    ...
                    fluidRow(column(4,style="width:25%;",
                                    box(title="Egg Survival",status="primary",solidHeader=TRUE,width=NULL,
                                        ...
                                        numericInput("eggS.mu.custom","Mean (default = 0.00648)",0.00648,min=0,max=0.5,step=0.0001),
                                        numericInput("eggS.var.custom","Variance (default = 0.0000915)",0.0000915,min=0,max=0.5,step=0.0000001))),
                             column(4,style="width:25%",
