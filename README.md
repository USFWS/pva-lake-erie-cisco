...
Details describing the model and preliminary results can be found in this [white paper](https://github.com/USFWS/pva-lake-erie-cisco/blob/main/wp_PVALakeErieCisco_GitHub.pdf).
